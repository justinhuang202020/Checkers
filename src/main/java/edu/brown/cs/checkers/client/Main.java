...
/**
 * Handles account sign up and adds it to the database
 * @author Justin Huang
 *
 */
...
/**
 * For the home page. Gets the record from the database for the user
 * @author Justin Huang
 *
 */
	...
	/**
	 *checks if a user already has a game in progress
	 * @author Justin Huang
	 *
	 */
